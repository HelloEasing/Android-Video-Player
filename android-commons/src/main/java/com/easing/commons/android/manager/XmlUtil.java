...
public class XmlUtil
{
  ...
  /**
   * 从一个简单结构的XML文件中读取二维数组</br>
   * 这个XML结构如下：</br>
   * [config]</br>
   * -- [key len1="5" len2="2"]</br>
   * ---- [item1]</br>
   * ------ [item2] value1 [/item2]</br>
   * ------ [item2] value2 [/item2]</br>
   * ---- [/item1]</br>
   * -- [/key]</br>
   * [config]</br>
   */
  ...
  public static void writeArray(File file, String key, Object[][] array2, int len1, int len2)
  {
    ...
    for (int i = 0; i < len1; i++)
    {
      ...
      nNode.setText(MathUtil.keepInt(i + 1, 3));
      aNode.add(nNode);
    }
