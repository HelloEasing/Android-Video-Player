...
public class TickButton extends View {
	...
	private void init(Context context, AttributeSet attrs) {
		...
		colorA = typedArray.getColor(R.styleable.TickButton_circleColor, ColorUtil.LIGHT_BLUE);
		colorB = typedArray.getColor(R.styleable.TickButton_tickColor, ColorUtil.WHITE);
		...
		wrapCirclePaint.setColor(ColorUtil.WHITE);
