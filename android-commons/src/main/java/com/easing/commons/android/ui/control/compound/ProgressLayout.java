...
public class ProgressLayout extends LinearLayout {
  ...
  private void init(Context context, AttributeSet attrSet) {
    ...
    //添加子节点
    View root = ViewManager.inflate(ctx, R.layout.layout_progress_layout_m01);
    super.addView(root, new LinearLayout.LayoutParams(ViewManager.MATCH_PARENT, ViewManager.MATCH_PARENT, 1));
    //设置图片动画
