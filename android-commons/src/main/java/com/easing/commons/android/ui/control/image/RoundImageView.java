...
import com.easing.commons.android.manager.BitmapUtil;
...
public class RoundImageView extends View {
    ...
    private void init(Context context, AttributeSet attrSet) {
        ...
        TypedArray attrs = context.obtainStyledAttributes(attrSet, R.styleable.RoundImageView);
        fontSize = attrs.getDimensionPixelSize(R.styleable.RoundImageView_fontSize, DimenUtil.toPx(context, 24));
        textColor = attrs.getColor(R.styleable.RoundImageView_textColor, ColorUtil.WHITE);
        drawBorder = attrs.getBoolean(R.styleable.RoundImageView_border, false);
        borderColor = attrs.getColor(R.styleable.RoundImageView_borderColor, ColorUtil.WHITE);
        borderWidth = attrs.getDimensionPixelSize(R.styleable.RoundImageView_borderWidth, 4);
        attrs.recycle();
    ...
    public void setImage(int drawableId) {
        mode = MODE_BITMAP;
        this.srcBitmap = BitmapUtil.decodeBitmapFromResource(context, drawableId);
        invalidate();
    }
