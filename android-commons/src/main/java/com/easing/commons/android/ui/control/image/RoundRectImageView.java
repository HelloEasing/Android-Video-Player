...
public class RoundRectImageView extends View {
    ...
    private void init(Context context, AttributeSet attrSet) {
        ...
        fontSize = attrs.getDimensionPixelSize(R.styleable.RoundRectImageView_fontSize, DimenUtil.toPx(context, 24));
        textColor = attrs.getColor(R.styleable.RoundRectImageView_textColor, ColorUtil.WHITE);
        ...
        borderColor = attrs.getColor(R.styleable.RoundRectImageView_borderColor, ColorUtil.WHITE);
