...
public class CompassView extends View {
  ...
  private void init(Context context, AttributeSet attrSet) {
    ...
    circleBitmap = BitmapUtil.decodeBitmapFromResource(ctx, R.drawable.compass_view_circle);
    pointerBitmap = BitmapUtil.decodeBitmapFromResource(ctx, R.drawable.compass_view_pointer);
