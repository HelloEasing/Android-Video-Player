...
public class LyricView extends View {
	...
	private void init(Context context, AttributeSet attrSet) {
		...
		int normalTextColor = attrs.getColor(R.styleable.LyricView_normalTextColor, ColorUtil.BLACK);
		int activeTextColor = attrs.getColor(R.styleable.LyricView_activeTextColor, ColorUtil.RED);
		attrs.recycle();
		...
		normalPaint.setShadowLayer(0.5f, 0.3f, 0.3f, ColorUtil.WHITE_50);
		activePaint.setMaskFilter(blur);
		activePaint.setShadowLayer(0.5f, 0.3f, 0.3f, ColorUtil.BLACK_50);
