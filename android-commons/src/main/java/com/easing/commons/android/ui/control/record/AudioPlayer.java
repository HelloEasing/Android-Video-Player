...
import com.easing.commons.android.media.MediaUtil;
...
public class AudioPlayer extends DialogFragment {
    ...
    public static AudioPlayer create(String source) {
        ...
        player.duration = MediaUtil.getMediaDuration(source);
        return player;
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        //设置控件内容
        sourceText.setText(FileUtil.getFileName(source));
        totalDurationText.setText(TimeUtil.msToMSTime(duration));
        ...
        Threads.postByInterval(() -> {
            GlobalHandler.post(() -> {
                synchronized (mediaPlayer) {
                    ...
                    finishDurationText.setText(TimeUtil.msToMSTime(finish));
                }
            });
        }, 500, state);
    }
