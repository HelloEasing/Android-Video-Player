...
public class TestView extends LinearLayout {
    ...
    private void init(Context context, AttributeSet attrSet) {
        //尺寸铺满容器
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(ViewManager.MATCH_PARENT, ViewManager.MATCH_PARENT);
        ...
        //背景色字体色互补
        paint = new Paint();
        int reverseColor = ColorUtil.reverseColor(color, 0xFF);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Size size = ViewManager.size(this);
