...
public class GalleryM1 extends HorizontalScrollView {
    ...
    private void customStyle(Context context, AttributeSet attrs) {
        ...
        ViewManager.size(leftPadder, PADDER_WIDTH, IMAGE_WIDTH, 0);
        ViewManager.size(rightPadder, PADDER_WIDTH, IMAGE_WIDTH, 0);
        ViewManager.setBackground(this, R.drawable.color_black_20);
    }
    ...
    private ImageViewM1 buildImageViewM1() {
        ...
        ViewManager.size(iv, IMAGE_WIDTH, IMAGE_WIDTH, 0f);
        ViewManager.setBackground(iv, R.drawable.container_back_m18);
        return iv;
    }
