...
public class ImageViewerM2 extends LinearLayout
{
  ...
  {
    View dispaly_pane = ViewManager.inflate(context, R.layout.layout_gallery_m02);
    ...
    ViewManager.size(gallery, ViewManager.MATCH_PARENT, ViewManager.WRAP_CONTENT, 0f);
