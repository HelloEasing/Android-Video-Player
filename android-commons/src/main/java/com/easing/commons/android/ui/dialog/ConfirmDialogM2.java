...
public class ConfirmDialogM2 {
    ...
    public static PopupWindow confirm(Activity context, Object msg, Action confirmAction, Action denyAction, Action cancelAction, int layoutId) {
        ...
        dialog.showAtLocation(ViewManager.getRootView(context), Gravity.CENTER, 0, 0);

        //设置弹窗内容
        TextView tv = ViewManager.findView(root, R.id.tv);
        ImageButtonM1 okButton = ViewManager.findView(root, R.id.bt_ok);
        ImageButtonM1 noButton = ViewManager.findView(root, R.id.bt_no);
